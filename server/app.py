...
def detect_cube_state(images):
    ...
    Each face is divided into a 3x3 grid; the average color of each cell is
    classified using HSV ranges to one of the cube colors.
    This routine is simplistic and works best in good lighting conditions.
    """

    # HSV color ranges for cube sticker colors
    color_ranges = {
